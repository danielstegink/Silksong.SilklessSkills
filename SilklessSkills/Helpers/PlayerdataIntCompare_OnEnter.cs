...
{
    [HarmonyPatch(typeof(PlayerdataIntCompare), "OnEnter")]
    public static class PlayerdataIntCompare_OnEnter
    {
        /// <summary>
        ...
        [HarmonyPrefix]
        public static void Prefix(PlayerdataIntCompare __instance)
        {
            if (NegateCost(__instance, out SilkSkills skill))
            {
                ...
                silkCosts[skill] = __instance.compareTo.Value;
                __instance.compareTo.Value = 0;
            }
        }

        [HarmonyPostfix]
        public static void Postfix(PlayerdataIntCompare __instance)
        {
...
#pragma warning disable CS8629 // Nullable value type may be null.
                __instance.compareTo.Value = silkCosts[skill].Value;
#pragma warning restore CS8629 // Nullable value type may be null.
        ...
        /// <returns></returns>
        private static bool NegateCost(PlayerdataIntCompare __instance, out SilkSkills skill)
        {
        ...
        /// <param name="__instance"></param>
        /// <returns></returns>
        private static SilkSkills GetCurrentSkill(PlayerdataIntCompare __instance)
        {
            if (__instance.fsm.name.Equals("Silk Specials") &&
                __instance.State.name.Equals("Silk Check"))
            {
